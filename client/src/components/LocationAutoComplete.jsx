			...
			<div className="LocationAutoComplete">
				...
				<ul className="LocationAutoComplete-results">
					{this.state.results.map((place) => (
						<li key={place.id} className="LocationAutoComplete-items" onClick={() => this.handleItemClicked(place)}>
							{place.place_name}
						</li>
					))}
					{this.state.isLoading && <li className="LocationAutoComplete-items">Loading...</li>}
				</ul>
			</div>
		);
	}
